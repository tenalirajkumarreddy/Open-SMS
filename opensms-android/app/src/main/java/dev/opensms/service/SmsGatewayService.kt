...
class SmsGatewayService : Service() {
    ...
    private fun getLocalIpAddress(): String {
        return try {
            ...
            try { InetAddress.getLocalHost().hostAddress ?: "Unknown" }
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("● OpenSMS Running  •  ${stats.sentToday()} sent today")
            .setContentText(url)
    ...
    private fun notifyFailure(to: String, reason: String) {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText("Failed to send to ${maskPhone(to)}: $reason")
            .setSmallIcon(R.drawable.ic_sms_notification)
            .setAutoCancel(true)
            .build()
